...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.061zho5.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const database = client.db('Foot-Frenzy');
